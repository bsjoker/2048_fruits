...
class BestActivity : AppCompatActivity() {
    ...
    val sharedPreferences = App.instance.getSharedPreferences("prefs", Context.MODE_PRIVATE)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_webview)

        var subs = sharedPreferences.getString("fb", "")
        Log.d("LastA", "Subs: $subs")
        ...
        with(webView) {
            ...
            loadUrl(sharedPreferences.getString("url", ""))
        }
    }
